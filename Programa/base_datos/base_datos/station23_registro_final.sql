...
--
-- Table structure for table `registro_final`
--
...
--
-- Dumping data for table `registro_final`
--

LOCK TABLES `registro_final` WRITE;
/*!40000 ALTER TABLE `registro_final` DISABLE KEYS */;
/*!40000 ALTER TABLE `registro_final` ENABLE KEYS */;
UNLOCK TABLES;
